 ...
 */
 ...
 if ($stmt = $con->prepare('SELECT id,sesion,email FROM sesiones WHERE sesion = ?')) {
...
default:
    ...
    default:
        ...
        echo $tpl->fetch();
         ...
         $web=$_SERVER['SERVER_NAME'];
         echo "No estas autorizado, adios muy buenas";
